...
{
	/// <summary>
	/// Second step in the concurrent entity collection builder flow: configures the serializer.
	/// </summary>
			...
			where TEntity : class
	{
		...
		public SerializerStep(IConcurrentEntityCollectionBuilder<TKey, TEntity> builder)
		{
			_builder = builder;
		}
